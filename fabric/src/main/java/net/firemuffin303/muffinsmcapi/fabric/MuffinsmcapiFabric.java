...
public final class MuffinsmcapiFabric implements ModInitializer {
    ...
    public static final OvenBoatVariant OVEN_BOAT = Registry.register(OVEN_BOAT_VARIANT_REGISTRY,MuffinsMcAPI.modid("oven"),new OvenBoatVariant(false));
    public static final OvenBoatVariant RAFT_OVEN_BOAT = Registry.register(OVEN_BOAT_VARIANT_REGISTRY,MuffinsMcAPI.modid("raft_oven"),new OvenBoatVariant(true));
