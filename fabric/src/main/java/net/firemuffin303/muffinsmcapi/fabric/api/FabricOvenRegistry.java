...
public class FabricOvenRegistry {
    public static final Registry<OvenBoatVariant> OVEN_BOAT_VARIANT_REGISTRY = FabricRegistryBuilder.createSimple(BoatRegistry.OVEN_BOAT_VARIANT).attribute(RegistryAttribute.SYNCED).buildAndRegister();
